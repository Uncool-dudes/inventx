...
CREATE TABLE "event_attendees" (
	"attendee_id" uuid PRIMARY KEY DEFAULT uuid_generate_v4() NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "project_attendees" (
	"project_id" uuid NOT NULL,
	"user_id" text NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "project_attendees_project_id_user_id_pk" PRIMARY KEY("project_id","user_id")
);
--> statement-breakpoint
...
ALTER TABLE "project_attendees" ADD CONSTRAINT "project_attendees_project_id_projects_project_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("project_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "project_attendees" ADD CONSTRAINT "project_attendees_user_id_users_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("user_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
